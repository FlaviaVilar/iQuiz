...
class QuestaoViewController: UIViewController {
    ...
    @IBAction func respostaBotaoPressionado(_ sender: UIButton) {
        ...
        if usuarioAcertouResposta {
            pontuacao += 1
            sender.backgroundColor = UIColor(red: 11/255, green: 161/155, blue: 53/255, alpha: 1.0)
        } else {
            sender.backgroundColor = UIColor(red: 211/255, green: 17/155, blue: 17/255, alpha: 1.0)
        }
